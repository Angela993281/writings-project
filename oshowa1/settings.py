"""
Django settings for oshowa1 project.
...
SECRET_KEY = 'django-insecure-&54&lq3^mk@@*%&g)wz4w!hsw5pbq#4k_s+sdali#s3-wj%q51'
...
WSGI_APPLICATION = 'oshowa1.wsgi.application'
